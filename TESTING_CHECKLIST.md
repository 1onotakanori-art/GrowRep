# GrowRep - インターバルモード機能テストチェックリスト

## Step 1: ヘッダーUIとモードセレクター
- [✅] ヘッダーが2行構成で表示される
- [✅] モードセレクターが表示される
- [✅] ノーマルモードとインターバルモードの選択肢が表示される
- [✅] モバイルビューで適切にスタックされる

## Step 2: モード状態管理
- [✅] モードセレクター変更時にモードが切り替わる
- [✅] タブの表示/非表示が適切に切り替わる
- [✅] インターバルタイマータブがインターバルモードでのみ表示される
- [✅] ログイン時にデフォルトでインターバルモードになる
...
### インターバルモード
- [✅] 投稿が`posts_interval`コレクションに保存される
- [✅] 倍率設定が`settings_interval`コレクションに保存される
- [✅] キャッシュが正しく動作する

### データ分離の確認
- [✅] ノーマルモードで投稿したデータがインターバルモードで表示されない
- [✅] インターバルモードで投稿したデータがノーマルモードで表示されない
- [✅] 倍率設定が各モードで独立している

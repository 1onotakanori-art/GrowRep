...
function updateModeInfo() {
    const modeTexts = {
        'prototype': {
            post: '📝 プロトタイプモード：通常のトレーニング記録を投稿してください',
            board: '📋 プロトタイプモードの投稿一覧です。このモードのデータのみ表示されます。',
            ranking: '🏆 プロトタイプモードのランキングです。このモードのデータのみ集計されます。',
            progress: '📊 プロトタイプモードの成長記録です。あなたの投稿履歴をグラフで確認できます。',
            rules: '📜 プロトタイプモードのルールと倍率設定です。倍率はこのモード専用の設定です。',
            score: '🎯 プロトタイプモードの総合得点です。各種目の最高記録から計算されます。'
        },
        '3sec-rule': {
            post: '⏱️ 3秒ルールモード：3秒タイマータブで音に合わせてトレーニングを行い、その記録を投稿してください',
            board: '📋 3秒ルールモードの投稿一覧です。このモードのデータのみ表示されます。',
            ranking: '🏆 3秒ルールモードのランキングです。このモードのデータのみ集計されます。',
            progress: '📊 3秒ルールモードの成長記録です。タイマーを使った記録の履歴をグラフで確認できます。',
            rules: '📜 3秒ルールモードのルールと倍率設定です。倍率はこのモード専用の設定です。3秒タイマーで正確なペースを保ってトレーニングしましょう。',
            score: '🎯 3秒ルールモードの総合得点です。各種目の最高記録から計算されます。'
        }
    };
    
    const currentTexts = modeTexts[currentMode];
    const modeClass = currentMode === 'prototype' ? 'prototype' : 'three-sec-rule';

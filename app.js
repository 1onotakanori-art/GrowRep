...
function updateModeInfo() {
    const modeTexts = {
        'normal': {
            post: '📝 ノーマルモード：通常のトレーニング記録を投稿してください',
            board: '📋 ノーマルモードの投稿一覧です。このモードのデータのみ表示されます。',
            ranking: '🏆 ノーマルモードのランキングです。このモードのデータのみ集計されます。',
            progress: '📊 ノーマルモードの成長記録です。あなたの投稿履歴をグラフで確認できます。',
            rules: '📜 ノーマルモードのルールと倍率設定です。倍率はこのモード専用の設定です。',
            score: '🎯 ノーマルモードの総合得点です。各種目の最高記録から計算されます。'
        },
        'interval': {
            post: '⏱️ インターバルモード：インターバルタイマータブで音に合わせてトレーニングを行い、その記録を投稿してください',
            board: '📋 インターバルモードの投稿一覧です。このモードのデータのみ表示されます。',
            ranking: '🏆 インターバルモードのランキングです。このモードのデータのみ集計されます。',
            progress: '📊 インターバルモードの成長記録です。タイマーを使った記録の履歴をグラフで確認できます。',
            rules: '📜 インターバルモードのルールと倍率設定です。倍率はこのモード専用の設定です。インターバルタイマーで正確なペースを保ってトレーニングしましょう。',
            score: '🎯 インターバルモードの総合得点です。各種目の最高記録から計算されます。'
        }
    };

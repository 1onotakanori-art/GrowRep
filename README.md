...
- ✅ コメント機能
- ✅ 投稿削除機能（投稿者本人のみ）
- ✅ **プロトタイプ / 3秒ルール 2モードシステム**
- ✅ **3秒タイマー機能（音声+視覚フィードバック）**
- ✅ **モード別データ完全分離（Firestore コレクション分離）**
...
#### 3秒ルールモード
- インターバルタイマーを使用した正確なペース管理
- カスタマイズ可能なインターバル（1〜60秒）
- 3種類の音声（チック音、ビープ音、カウントダウン音）
- 10秒の準備時間カウントダウン
- タイマータブで Start / Stop / Reset 制御

### データ分離
- 各モードのデータは完全に独立
- Firestoreコレクション:
  - ノーマルモード: `posts`, `settings`
  - インターバルモード: `posts_interval`, `settings_interval`
- 倍率設定もモード別に管理
- モード切り替え時に適切なデータを表示
